                    ...
                    <fieldset className="border-0 p-0 m-0">
                        ...
                        <div>
                            ...
                            <div className="flex items-center border border-gray-200 rounded-lg px-4 py-2 focus-within:ring-2 focus-within:ring-[#294D1C]">
                                ...
                                <input id="nome" name="nome" type="text" className="w-full bg-transparent outline-none" placeholder="Seu nome" />
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="flex items-center border border-gray-200 rounded-lg px-4 py-2 focus-within:ring-2 focus-within:ring-[#294D1C]">
                                ...
                                <input id="senha" name="senha" type="password" className="w-full bg-transparent outline-none" placeholder="Crie uma senha" />
                            </div>
                        </div>
                    </fieldset>
